...
public class Evento implements Serializable {
	...
	public Evento(int idEvento, int aforoMaximo, String descripcion, String destacado, String direccion, int duracion,
			String estado, Date fechaInicio, int idTipo, int minimoAsistencia, String nombre, BigDecimal precio) {
		super();
	...
	public String toString() {
		return "Evento [idEvento=" + idEvento + ", aforoMaximo=" + aforoMaximo + ", descripcion=" + descripcion
				...
				+ estado + ", fechaInicio=" + fechaInicio + ", idTipo=" + idTipo + ", minimoAsistencia="
				+ minimoAsistencia + ", nombre=" + nombre + ", precio=" + precio + "]";
	}
